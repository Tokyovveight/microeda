...
#' @param metadata Optional sample metadata. Required when `group` is supplied
#'   for non-phyloseq inputs.
#' @param group Optional sample metadata column used for group labels, grouped
